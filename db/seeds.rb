Beverage.create!([
  {name: "Black Coffee", price: 80.0, description: "Black coffee is simply coffee that is normally brewed without the addition of additives such as sugar, milk, cream, or added flavors. While it has a slightly bitter taste compared to when it is flavored with additives, many people love a strong cup of black coffee. In fact, for some, it is part of their everyday diet.", expiry: "2022-09-10", available: true},
  {name: "Coffee with milk", price: 100.0, description: "Milk Coffee are considered an introductory coffee drink since the acidity and bitterness of coffee is cut by the amount of milk in the beverage.", expiry: "2022-09-10", available: true},
  {name: "(Sugarless) Coffee with milk", price: 90.0, description: "Sugarless Milk Coffee are considered an introductory coffee drink since the acidity of coffee is cut by the amount of milk in the beverage. It will come without sugar and the taste will incline towards the bitter side", expiry: "2022-09-10", available: true},
  {name: "(Sugarless) Black Coffee", price: 50.0, description: "Sugarless Black coffee is simply coffee that is normally brewed without the addition of additives such as sugar, milk, cream, or added flavors. While it has a slightly bitter taste compared to when it is flavored with additives, many people love a strong cup of black coffee. In fact, for some, it is part of their everyday diet. It will come without sugar and the taste will incline towards the bitter side", expiry: "2022-09-10", available: true}
])
Ingredient.create!([
  {name: "Water", available_units: 100, price: 10},
  {name: "Coffee", available_units: 100, price: 40.0},
  {name: "Sugar", available_units: 100, price: 10.0},
  {name: "Milk", available_units: 100, price: 20.0}
])
